cc.Class({
    ...
    checkLoginResult: function() {
     ...
     singleLinePassword1EditBoxDidBeginEditing: function(sender) {
        cc.log(sender.node.name + " single line password1 editBoxDidBeginEditing");
    },
    
    singleLinePassword1EditBoxDidChanged: function(text, sender) {
        this.pwd1.string = "";
        if(text === '')return;
        this.index ++;
